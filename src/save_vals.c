...
// send in smtms and split up to save into t_find, t_values and stmts->valImp . see how called in main of filler sceleton. then change save_piece to save other things...
t_find    *seperate_vals(t_stmts *node, t_g *all)
{
